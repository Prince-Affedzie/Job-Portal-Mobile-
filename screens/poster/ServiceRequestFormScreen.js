...
const ServiceRequestFormScreen = ({ route }) => {
  ...
  // Media Upload Functions (keep your existing implementation)
  ...
  const validateForm = () => {
    ...
    if (!formData.locationString.trim()) {
      newErrors.locationString = 'Service location is required';
    }
    ...
    try {
      ...
      if (response.status === 200) {
        Alert.alert(
          ...
          `Your service request has been sent to ${selectedTaskers.length} tasker${selectedTaskers.length !== 1 ? 's' : ''}. You'll be notified when they respond.`,
          [
            { 
              text: 'View Requests', 
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Header title="Create Service Request" showBackButton />
      ...
      >
        {/* Selected Taskers Preview */}
        <FormSection 
          title="Selected Professionals" 
          icon="people-outline"
          description={`Your request will be sent to ${selectedTaskers.length} tasker${selectedTaskers.length !== 1 ? 's' : ''}`}
        >
          <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.taskersScroll}>
            {selectedTaskers.map((tasker, index) => (
        ...
        <FormSection 
          ...
          icon="images-outline"
          description="Add reference images or videos (optional)"
        >
        ...
        <FormSection 
          ...
          description="List any specific deliverables or requirements"
        >
        ...
        <FormSection 
          ...
          icon="cash-outline"
          description="Set your budget and preferred timeline"
        >
          <InputField
        ...
        >
          <InputField
            ...
            placeholder="Enter service location (e.g., East Legon, Accra)"
          ...
          <View style={styles.locationNote}>
            ...
            <Text style={styles.locationNoteText}>
              This location will be shared with the selected taskers. Be as specific as possible.
            </Text>
          </View>
        </FormSection>
