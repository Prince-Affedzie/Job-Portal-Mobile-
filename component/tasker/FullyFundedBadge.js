...
const FundingNoticeCard = ({ task, isAssignedToUser }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.message}>
        Payment secured in escrow. Contact support if you need some of the funds for tools/equipments purchasing for this project.
      </Text>
...
export default FundingNoticeCard;